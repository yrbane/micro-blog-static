...
<div class="page-header">
    <div class="page-header-content">
        ...
        <p class="text-muted">Organisez vos articles par catégories</p>
    </div>
        ...
        <div class="table-container">
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <span class="category-name">[[ cat.indented_name ]]</span>
                        </td>
                        <td class="text-muted text-sm">[[ cat.slug ]]</td>
                        <td>
                            <span class="badge badge-secondary">[[ cat.post_count ]]</span>
                        </td>
                        <td class="text-right">
                            <div class="btn-group">
                                <a href="/admin/categories/[[ cat.id ]]/edit" class="btn btn-sm btn-ghost" title="Modifier">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                        <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                                        <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                                    </svg>
                                </a>
                                <form action="/admin/categories/[[ cat.id ]]/delete" method="POST" class="inline-form">
